...
<div class="w3-top" >
  <div class="w3-bar w3-white w3-wide w3-padding w3-card-2 ">
    <a href="#home" class="w3-bar-item w3-button"><div class="w3-container" style="width: 100px"><img src="images/logo1.png" style="width: 100%"></div></a>
    <div>&nbsp</div>
    <div class="w3-blue">
    ...
    <div class="w3-right w3-hide-small ">
      <a href="login.php?lCtr=1" class="w3-bar-item w3-button w3-border w3-border-purple w3-hover-purple">Create Free Account</a>
      <a href="#about" class="w3-bar-item w3-button w3-border">Log in</a>
    </div>
  </div>
</div>
